...
public class FrameBuffer {
    ...
    private final int MULTISAMPLING_LEVEL = 8   ;
    ...
    private void createDepthBufferAttachment() {
        ...
        if (useMultisampling) {
            GL30.glRenderbufferStorageMultisample(GL30.GL_RENDERBUFFER, MULTISAMPLING_LEVEL, GL14.GL_DEPTH_COMPONENT24, width, height);
        } else {
    ...
    private void createMultisampleColorAttachment() {
        ...
        GL30.glRenderbufferStorageMultisample(GL30.GL_RENDERBUFFER, MULTISAMPLING_LEVEL, GL11.GL_RGBA8, width, height);
    ...
    public void resolveToFrameBuffer(FrameBuffer outputFrameBuffer) {
        GL30.glBindFramebuffer(GL30.GL_DRAW_FRAMEBUFFER, outputFrameBuffer.frameBuffer);
        GL30.glBindFramebuffer(GL30.GL_READ_FRAMEBUFFER, this.frameBuffer);
        GL30.glBlitFramebuffer(0, 0, width, height, 0, 0, outputFrameBuffer.width, outputFrameBuffer.height,
